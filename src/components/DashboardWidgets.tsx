...
const WIDGET_TYPES: WidgetTypeOption[] = [
    ...
    },
    {
        type: "bar",
        label: "Bar Chart",
        description: "Category distribution as bar chart",
    ...
    },
    {
        type: "pie",
        label: "Pie Chart",
        description: "Status distribution as pie chart",
        icon: <PieChart className="w-5 h-5" />
    }
];

export const DashboardWidgets = () => {
    const { tasks, widgets, savedFilters, addWidget, removeWidget } = useTaskStore();
    ...
    const handleAddWidget = (filterId: string) => {
                        ...
                        <div className="p-6 overflow-y-auto flex-1">
                            {!selectedWidgetType ? (
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div>
                                        <h3 className="font-semibold mb-3">Choose a data source:</h3>
                                            ...
                                            <div className="grid grid-cols-1 gap-2 max-h-96 overflow-y-auto">
                                                {savedFilters.map(filter => {
                                                    ...
                                                    return (
                                                        <button
                                                            key={filter.id}
                                                            onClick={() => !alreadyAdded && handleAddWidget(filter.id)}
            ...
            {widgets.length === 0 ? (
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {widgets.map(widget => {
                        ...
                        const stats = calculateWidgetStats(tasks, filter.criteria);
